...
const (
	...
	PlayerType_ROBOT PlayerType = 1 // Робот, управляет своей змеёй с помощью алгоритма (вне задачи, для желающих)
)
...
type GamePlayer struct {
	...
	IpAddress *string     `protobuf:"bytes,3,req,name=ip_address,json=ipAddress" json:"ip_address,omitempty"`    // IPv4 или IPv6 адрес игрока в виде строки (отправитель не знает свой IP, поэтому указывает тут пустую строку)
	Port      *int32      `protobuf:"varint,4,req,name=port" json:"port,omitempty"`                              // Порт UDP-сокета игрока
...
type GameConfig struct {
	...
	FoodPerPlayer *float32 `protobuf:"fixed32,4,opt,name=food_per_player,json=foodPerPlayer,def=1" json:"food_per_player,omitempty"`  // Количество клеток с едой, на каждого игрока (вещественный коэффициент от 0 до 100)
	StateDelayMs  *int32   `protobuf:"varint,5,opt,name=state_delay_ms,json=stateDelayMs,def=1000" json:"state_delay_ms,omitempty"`   // Задержка между ходами (сменой состояний) в игре, в миллисекундах (от 1 до 10000)
	DeadFoodProb  *float32 `protobuf:"fixed32,6,opt,name=dead_food_prob,json=deadFoodProb,def=0.1" json:"dead_food_prob,omitempty"`   // Вероятность превращения мёртвой клетки в еду (от 0 до 1).
	PingDelayMs   *int32   `protobuf:"varint,7,opt,name=ping_delay_ms,json=pingDelayMs,def=100" json:"ping_delay_ms,omitempty"`       // Задержка между отправкой ping-сообщений, в миллисекундах (от 1 до 10000)
	NodeTimeoutMs *int32   `protobuf:"varint,8,opt,name=node_timeout_ms,json=nodeTimeoutMs,def=800" json:"node_timeout_ms,omitempty"` // Таймаут, после которого считаем что узел-сосед отпал, в миллисекундах (от 1 до 10000)
}
...
const (
	...
	Default_GameConfig_FoodPerPlayer = float32(1)
	Default_GameConfig_StateDelayMs  = int32(1000)
	Default_GameConfig_DeadFoodProb  = float32(0.10000000149011612)
	Default_GameConfig_PingDelayMs   = int32(100)
	Default_GameConfig_NodeTimeoutMs = int32(800)
)
...
func (x *GameConfig) GetFoodPerPlayer() float32 {
	if x != nil && x.FoodPerPlayer != nil {
		return *x.FoodPerPlayer
	}
...
func (x *GameConfig) GetDeadFoodProb() float32 {
	if x != nil && x.DeadFoodProb != nil {
		return *x.DeadFoodProb
	}
	return Default_GameConfig_DeadFoodProb
}

func (x *GameConfig) GetPingDelayMs() int32 {
...
func (x *GameConfig) GetNodeTimeoutMs() int32 {
	if x != nil && x.NodeTimeoutMs != nil {
		return *x.NodeTimeoutMs
	}
...
type GameState struct {
	...
	Config     *GameConfig        `protobuf:"bytes,5,req,name=config" json:"config,omitempty"`                            // Параметры игры
}
...
func (*GameMessage_PingMsg) Descriptor() ([]byte, []int) {
	return file_snakes_proto_rawDescGZIP(), []int{4, 0}
}
...
func (*GameMessage_SteerMsg) Descriptor() ([]byte, []int) {
	return file_snakes_proto_rawDescGZIP(), []int{4, 1}
}
...
func (*GameMessage_AckMsg) Descriptor() ([]byte, []int) {
	return file_snakes_proto_rawDescGZIP(), []int{4, 2}
}
...
func (*GameMessage_StateMsg) Descriptor() ([]byte, []int) {
	return file_snakes_proto_rawDescGZIP(), []int{4, 3}
}
...
// Default values for GameMessage_AnnouncementMsg fields.
const (
	Default_GameMessage_AnnouncementMsg_CanJoin = bool(true)
)
...
func (*GameMessage_AnnouncementMsg) Descriptor() ([]byte, []int) {
	return file_snakes_proto_rawDescGZIP(), []int{4, 4}
}

func (x *GameMessage_AnnouncementMsg) GetPlayers() *GamePlayers {
	if x != nil {
		return x.Players
	}
	return nil
...
func (x *GameMessage_AnnouncementMsg) GetConfig() *GameConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *GameMessage_AnnouncementMsg) GetCanJoin() bool {
...
type GameMessage_JoinMsg struct {
	...
	OnlyView   *bool       `protobuf:"varint,2,opt,name=only_view,json=onlyView,def=0" json:"only_view,omitempty"`                              // Если хотим только понаблюдать, но не играть
	Name       *string     `protobuf:"bytes,3,req,name=name" json:"name,omitempty"`                                                             // Имя игрока
}

// Default values for GameMessage_JoinMsg fields.
const (
	Default_GameMessage_JoinMsg_PlayerType = PlayerType_HUMAN
	Default_GameMessage_JoinMsg_OnlyView   = bool(false)
)
...
func (*GameMessage_JoinMsg) Descriptor() ([]byte, []int) {
	return file_snakes_proto_rawDescGZIP(), []int{4, 5}
}
...
func (x *GameMessage_JoinMsg) GetOnlyView() bool {
	if x != nil && x.OnlyView != nil {
		return *x.OnlyView
	}
	return Default_GameMessage_JoinMsg_OnlyView
}

func (x *GameMessage_JoinMsg) GetName() string {
	if x != nil && x.Name != nil {
		return *x.Name
	}
	return ""
...
func (*GameMessage_ErrorMsg) Descriptor() ([]byte, []int) {
	return file_snakes_proto_rawDescGZIP(), []int{4, 6}
}
...
func (*GameMessage_RoleChangeMsg) Descriptor() ([]byte, []int) {
	return file_snakes_proto_rawDescGZIP(), []int{4, 7}
}
...
var file_snakes_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x02, 0x28, 0x09, 0x52, 0x09, 0x69,
	0x70, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x72, 0x74,
	0x18, 0x04, 0x20, 0x02, 0x28, 0x05, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x24, 0x0a, 0x04,
	...
	0x52, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x22, 0xbe, 0x02, 0x0a, 0x0a, 0x47, 0x61, 0x6d, 0x65,
	...
	,
	...
	0x20, 0x01, 0x28, 0x11, 0x3a, 0x01, 0x30, 0x52, 0x01, 0x79, 0x1a, 0xf5, 0x01, 0x0a, 0x05, 0x53,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x6f, 0x64, 0x75, 0x6e, 0x2f, 0x6e, 0x73, 0x75, 0x2d, 0x6e, 0x65, 0x74, 0x73, 0x2f,
	0x6c, 0x61, 0x62, 0x34,
}
...
var file_snakes_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_snakes_proto_goTypes = []interface{}{
	...
	(*GameMessage)(nil),                 // 8: snakes.GameMessage
	(*GameState_Coord)(nil),             // 9: snakes.GameState.Coord
	(*GameState_Snake)(nil),             // 10: snakes.GameState.Snake
	(*GameMessage_PingMsg)(nil),         // 11: snakes.GameMessage.PingMsg
	(*GameMessage_SteerMsg)(nil),        // 12: snakes.GameMessage.SteerMsg
	(*GameMessage_AckMsg)(nil),          // 13: snakes.GameMessage.AckMsg
	(*GameMessage_StateMsg)(nil),        // 14: snakes.GameMessage.StateMsg
	(*GameMessage_AnnouncementMsg)(nil), // 15: snakes.GameMessage.AnnouncementMsg
	(*GameMessage_JoinMsg)(nil),         // 16: snakes.GameMessage.JoinMsg
	(*GameMessage_ErrorMsg)(nil),        // 17: snakes.GameMessage.ErrorMsg
	(*GameMessage_RoleChangeMsg)(nil),   // 18: snakes.GameMessage.RoleChangeMsg
}
var file_snakes_proto_depIdxs = []int32{
	...
	10, // 3: snakes.GameState.snakes:type_name -> snakes.GameState.Snake
	9,  // 4: snakes.GameState.foods:type_name -> snakes.GameState.Coord
	6,  // 5: snakes.GameState.players:type_name -> snakes.GamePlayers
	5,  // 6: snakes.GameState.config:type_name -> snakes.GameConfig
	11, // 7: snakes.GameMessage.ping:type_name -> snakes.GameMessage.PingMsg
	12, // 8: snakes.GameMessage.steer:type_name -> snakes.GameMessage.SteerMsg
	13, // 9: snakes.GameMessage.ack:type_name -> snakes.GameMessage.AckMsg
	14, // 10: snakes.GameMessage.state:type_name -> snakes.GameMessage.StateMsg
	15, // 11: snakes.GameMessage.announcement:type_name -> snakes.GameMessage.AnnouncementMsg
	16, // 12: snakes.GameMessage.join:type_name -> snakes.GameMessage.JoinMsg
	17, // 13: snakes.GameMessage.error:type_name -> snakes.GameMessage.ErrorMsg
	18, // 14: snakes.GameMessage.role_change:type_name -> snakes.GameMessage.RoleChangeMsg
	9,  // 15: snakes.GameState.Snake.points:type_name -> snakes.GameState.Coord
	3,  // 16: snakes.GameState.Snake.state:type_name -> snakes.GameState.Snake.SnakeState
	2,  // 17: snakes.GameState.Snake.head_direction:type_name -> snakes.Direction
	2,  // 18: snakes.GameMessage.SteerMsg.direction:type_name -> snakes.Direction
	7,  // 19: snakes.GameMessage.StateMsg.state:type_name -> snakes.GameState
	6,  // 20: snakes.GameMessage.AnnouncementMsg.players:type_name -> snakes.GamePlayers
	5,  // 21: snakes.GameMessage.AnnouncementMsg.config:type_name -> snakes.GameConfig
	1,  // 22: snakes.GameMessage.JoinMsg.player_type:type_name -> snakes.PlayerType
	0,  // 23: snakes.GameMessage.RoleChangeMsg.sender_role:type_name -> snakes.NodeRole
	0,  // 24: snakes.GameMessage.RoleChangeMsg.receiver_role:type_name -> snakes.NodeRole
...
func file_snakes_proto_init() {
	...
	file_snakes_proto_msgTypes[4].OneofWrappers = []interface{}{
